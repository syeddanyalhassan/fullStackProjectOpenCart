...
function Registration() {
  ...
  // Correct useState declarations using array destructuring
      ...
      <div className='max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blur-2x1 rounded-lg shadow-lg flex items-center justify-center'>
        <form action='' onSubmit={handleSignUp} className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
          ...
          <div className='w-[90%] h-[400px] flex flex-col items-center justify-start gap-[15px]'>
            ...
            {!show && <IoEyeOutline className='w-[20px] h-[20px] cursor-pointer absolute bottom-[248px] left-[62%]' onClick={() => setShow((prev) => !prev)} />}
            {show && <IoEye className='w-[20px] h-[20px] cursor-pointer absolute bottom-[248px] left-[62%]' onClick={() => setShow((prev) => !prev)} />}

            <button className='w-[100%] h-[50px] bg-[#6060f5] rounded-lg flex items-center justify-center mt-[20px] text-[17px] font semi-bold'>
              Create Account
            </button>
